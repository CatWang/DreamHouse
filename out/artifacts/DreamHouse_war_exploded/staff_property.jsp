    ...
    <div class="courses">
      <div class="separator">
        <%
          ...
          IPropertyDAO dao = factory.getIPropertyDAOInstance();
          String branchNo = request.getParameter("branchNo");
          LinkedList<MutipleInt> result= dao.staffProperty(branchNo);
          for(MutipleInt rs :result){
            String branch = rs.getS2();
            String staffNo = rs.getS1();
            int properties = rs.getInt1();
        %>
        <ul class="separator-class">
          <li><%=branch%></li>
          <li><%=staffNo%></li>
