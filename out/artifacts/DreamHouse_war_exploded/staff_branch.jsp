...
<%@ page import="dream.daoInterface.IStaffDAO" %>
<%@ page import="dream.entity.Staff" %>
...
<div class="bar">
  <div class="bar-title bar-title-18"><h2>Staff Data</h2></div>
    ...
    <div class="courses">
      <div class="separator">
        <%
          ...
          IStaffDAO dao = factory.getIStaffDAOInstance();
          String branchNo = request.getParameter("branchNo");
          System.out.println(branchNo);
          LinkedList<Staff> result= dao.getStaffByBranch(branchNo);
