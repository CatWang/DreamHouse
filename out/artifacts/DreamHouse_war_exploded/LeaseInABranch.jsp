...
<%@ page import="dream.daoInterface.*" %>
<%--
    ...
    <div class="courses">
      <div class="separator">
        <%
          ...
          IBranchLeaseDAO dao = factory.getIBranchLeaseDAOInstance();
          String key = request.getParameter("branchNo");
          LinkedList<Lease> result= dao.findLeaseByBranchNo(key);
