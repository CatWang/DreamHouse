...
<div class="bar">
  <div class="bar-title bar-title-18"><h2>Ad Data</h2></div>
  <div class="coursetable">
    <div class="ct-week">
      <ul>
        <li>PropertyNo</li>
        <li>Ad Date</li>
        <li>Newspaper Name</li>
        <li>Cost</li>
      </ul>
    </div>
    <div class="ct-time">
    ...
    <div class="courses">
      <div class="separator">
        <%
          ...
          IAdDAO adDAO = factory.getIAdDAOInstance();
          LinkedList<Ad> result= adDAO.getAll();
          for(Ad ad :result){
            String propNo=ad.getPropNo();
            Date adDate = ad.getAdDate();
            String newsName = ad.getNewsName();
            Double cost = ad.getCost();
        %>
        <ul class="separator-class">
          <li><%=propNo%></li>
          <li><%=adDate%></li>
