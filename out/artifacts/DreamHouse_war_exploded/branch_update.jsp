...
<head>
  <meta charset="UTF-8">
  <title>Update Branch Data</title>
...
<div class="bar">
  <div class="bar-title bar-title-18"><h2>Update Branch Data</h2></div>
  <div class="coursetable">
    ...
    <div class="courses">
      <div class="separator">
        ...
        %>
        <s:form action="updateBranchAction" method="post">
        <ul class="separator-class">
          ...
          <li><s:textfield name="branch.teleNo" tooltip="telephone"
            ...
            <li><s:submit id="sumit" class="tf" value="update" /> </li>
        </ul>
        </s:form>
        <%
          }
