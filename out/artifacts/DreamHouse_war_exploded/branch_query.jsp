...
<%@ page import="dream.daoInterface.IPropertyDAO" %>
<%@ page import="dream.entity.Property" %>
<%--
...
<div class="bar">
  <div class="bar-title bar-title-18"><h2>Query Data</h2></div>
  <br class="coursetable">
    <h3>Find Branch With Keyword</h3>
      <ul class="separator-class">
       <form action="branch_result.jsp" method="post">
        <li><input type="text" name="key" placeholder="Key Word" /></li>
        <li><input type="submit" value="Query" /></li>
        </form>
      </ul>
    <br />
    <h3>Find Lease Details In A Branch</h3>
    <ul class="separator-class">
      <form action="LeaseInABranch.jsp" method="post">
        <li><input type="text" name="branchNo" placeholder="BranchNo"/></li>
        <li><input type="submit" value="Query"></li>
      </form>
    </ul>
  <br />
    <h3>Figure Out Total Number of Branch In Each City</h3>
    <ul class="separator-class">
    <form action="city_branch.jsp" method="post">
      <li><input type="submit" value="Query"></li>
    </form>
    </ul>
  <br />
    <h3>List Staffs In A Given Branch</h3>
    <ul class="separator-class">
      <form action="staff_branch.jsp" method="post">
        <li><input type="text" name="branchNo" placeholder="BranchNo"/></li>
        <li><input type="submit" value="Query"></li>
      </form>
    </ul>
  <br />
    <h3>Total Number Of Staff And Their Salaries Sum</h3>
    <ul class="separator-class">
      <form action="staff_total.jsp" method="post">
        <li><input type="submit" value="Query"></li>
      </form>
    </ul>
  <br />
    <h3>Manager Name Of Each Branch</h3>
    <ul class="separator-class">
      <form action="branch_manager.jsp" method="post">
        <li><input type="submit" value="Query"></li>
      </form>
    </ul>
  <br />
    <h3>Total Max Rent Per Month For Each Branch</h3>
    <ul class="separator-class">
      <form action="rent_branch.jsp" method="post">
        <li><input type="submit" value="Query"></li>
      </form>
    </ul>
  <br />
    <h3>Total Lease Less for One Year In Each Branch</h3>
    <ul class="separator-class">
      <form action="lease_total.jsp" method="post">
        <li><input type="submit" value="Query"></li>
      </form>
    </ul>
  <br />
    <h3>Property With Room No Less Than And Rent Fee No Higher Than</h3>
    <ul class="separator-class">
      <form action="property_want.jsp" method="post">
        <li><input type="text" name="room" placeholder="No Less Than How Many Rooms"/> </li>
        <li><input type="text" name="rent" placeholder="No Higher Than How Much"></li>
        <li><input type="submit" value="Query"></li>
      </form>
    </ul>
  <br />
    <h3>Total Properties Assinged To Each Staff At A Given Branch</h3>
    <ul class="separator-class">
      <form action="staff_property.jsp" method="post">
        <li><input type="text" name="branchNo" placeholder="BranchNo" /> </li>
        <li><input type="submit" value="Query"></li>
      </form>
    </ul>
  ...
  <br />
  <h3>List details of staff supervised by a named Supervisor at the branch</h3>
  <ul class="separator-class">
    <form action="supervise_by.jsp" method="post">
  ...
  <br />
  <h3>List the details of properties that have not been rented out for more than three months</h3>
  <ul class="separator-class">
    <form action="not_rent_for_three.jsp" method="post">
      <li><input type="submit" value="Query"></li>
    </form>
  </ul>
  <br/>
  <h3>Produce a list of clients whose preferences match a particular property</h3>
  <ul class="separator-class">
    <form action="match_client.jsp" method="post">
      <li><input type="submit" value="Query"></li>
    </form>
  </ul>
  <br/>
  <h3>Display the details of a lease between a named client and a given property</h3>
  <ul class="separator-class">
    <form action="match_lease.jsp" method="post">
      <li><input type="text" name="propNo" placeholder="PropertyNo" /> </li>
      <li><input type="text" name="fName" placeholder="Client First Name" /> </li>
      <li><input type="text" name="lName" placeholder="Client Last Name" /></li>
      <li><input type="submit" value="Query"></li>
    </form>
  </ul>
  <br/>
  <h3>Display the names and phone numbers of clients who have viewed a given property but not supplied comments</h3>
  <ul class="separator-class">
    <form action="client_twoinfo.jsp" method="post">
      <li><input type="submit" value="Query"></li>
    </form>
  </ul>
  <br />
  <h3>List the details of comments made by clients viewing a given property</h3>
  <ul class="separator-class">
    <form action="detail_comment.jsp" method="post">
      <li><input type="text" name="propNo" placeholder="PropertyNo" /> </li>
      <li><input type="submit" value="Query"></li>
    </form>
  </ul>
  <br />
  <h3>Identify the name and telephone number of an owner of a given property</h3>
  <ul class="separator-class">
    <form action="owner_twoinfo.jsp" method="post">
      <li><input type="text" name="propNo" placeholder="PropertyNo" /> </li>
      <li><input type="submit" value="Query"></li>
    </form>
  </ul>
