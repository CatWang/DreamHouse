...
<%@ page import="dream.entity.cityBranch" %>
...
<div class="bar">
  <div class="bar-title bar-title-18"><h2>Branch Data</h2></div>
    ...
    <div class="courses">
      <div class="separator">
        <%
          ...
          LinkedList<cityBranch> result = dao.cityBranch();
          for(cityBranch cityBranch :result){
            String city=cityBranch.getCity();
            int branchNum = cityBranch.getBranchNum();
        %>
        <ul class="separator-class">
          <li><%=city%></li>
          <li><%=branchNum%></li>
