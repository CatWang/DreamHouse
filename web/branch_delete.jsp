...
<head>
  <meta charset="UTF-8">
  <title>Delete Branch Data</title>
...
<div id="nav">
  <ul class="nav-menu clearfix unstyled">
    ...
    <li><a href="score.jsp" class="three-d">
      Upadate
...
<div class="bar">
  <div class="bar-title bar-title-18"><h2>Delete Branch Data</h2></div>
    ...
    <div class="courses">
      <div class="separator">
        <%
          ...
          LinkedList<Branch> result= branchDAO.getAllBranch();
          for(Branch branch :result){
            String branchNo=branch.getBranchNo();
            String street=branch.getStreet();
            String city=branch.getCity();
            String postcode=branch.getPostcode();
            String teleNo=branch.getTeleNo();
            String managerNo=branch.getManagerNo();
        %>
        <s:form action="deleteBranchAction" method="post">
          <ul class="separator-class">

            <li><s:textfield name="branch.branchNo" tooltip="Branch NO"
                             class="tf" placeholder="<%=branchNo%>"/></li>
            ...
            <li><s:submit id="sumit" class="tf" value="delete" /> </li>
          </ul>
        </s:form>
        <%
          }
