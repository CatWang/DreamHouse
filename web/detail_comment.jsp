...
<%@ page import="dream.daoInterface.IViewingDAO" %>
<%@ page import="dream.entity.Viewing" %>
...
<div class="bar">
  <div class="bar-title bar-title-18"><h2>Viewing Data</h2></div>
    ...
    <div class="courses">
      <div class="separator">
        <%
          ...
          IViewingDAO dao = factory.getIViewingDAOInstance();
          String prop = request.getParameter("propNo");
          LinkedList<Viewing> result= dao.detailComment(prop);
          for(Viewing rs :result){
            String clientNo = rs.getClientNo();
            String propNo = rs.getPropNo();
            Date viewDate = rs.getViewDate();
