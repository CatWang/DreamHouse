...
<%@ page import="dream.daoInterface.IAdDAO" %>
<%@ page import="dream.entity.Ad" %>
<%@ page import="java.sql.Date" %>
<%@ page import="java.util.DoubleSummaryStatistics" %>
<%@ page import="dream.daoInterface.IClientDAO" %>
<%@ page import="dream.entity.Client" %>
<%@ page import="dream.daoInterface.ILeaseDAO" %>
<%@ page import="dream.db.LeaseDAO" %>
<%@ page import="dream.entity.Lease" %>
<%--
  ...
  <ul class="nav-menu clearfix unstyled">
    ...
    <li><a href="branch_query.jsp" class="three-d">
      ...
      <ul class="clearfix unstyled drop-menu">
        ...
        <li><a href="client_query.jsp" class="three-d">
          Client
          <span class="three-d-box"><span class="front">Client</span><span class="back">Client</span></span>
        </a></li>
        <li><a href="staff_query.jsp" class="three-d">
          Staff
          <span class="three-d-box"><span class="front">Staff</span><span class="back">Staff</span></span>
        </a></li>
        <li><a href="property_query.jsp" class="three-d">
          Property
          <span class="three-d-box"><span class="front">Property</span><span class="back">Property</span></span>
        </a></li>
        <li><a href="owner_query.jsp" class="three-d">
          Owner
          <span class="three-d-box"><span class="front">Owner</span><span class="back">Owner</span></span>
        </a></li>
        <li><a href="viewing_query.jsp" class="three-d">
          Viewing
          <span class="three-d-box"><span class="front">Viewing</span><span class="back">Viewing</span></span>
        </a></li>
        <li><a href="lease_query.jsp" class="three-d">
          Lease
          <span class="three-d-box"><span class="front">Lease</span><span class="back">Lease</span></span>
        </a></li>
        <li><a href="newspaper_query.jsp" class="three-d">
          Newspaper
          <span class="three-d-box"><span class="front">Newspaper</span><span class="back">Newspaper</span></span>
        </a></li>
        <li><a href="ad_query.jsp" class="three-d">
          Ad
          <span class="three-d-box"><span class="front">Ad</span><span class="back">Ad</span></span>
        </a></li>
      </ul>
...
<div class="bar">
  <div class="bar-title bar-title-18"><h2>Lease Data</h2></div>
    ...
    <div class="courses">
      <div class="separator">
        <%
          ...
          ILeaseDAO leaseDAO = factory.getILeaseDAOInstance();
          String prop = request.getParameter("propNo");
          String f = request.getParameter("fName");
          String l = request.getParameter("lName");
          LinkedList<Lease> result= leaseDAO.match(prop, f, l);
          for(Lease lease :result){
            String leaseNo=lease.getLeaseNo();
            String clientNo = lease.getClientNo();
            String propNo = lease.getPropNo();
            String payMethod = lease.getPayMethod();
            boolean depositPaid = lease.isDepositPaid();
