...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/city_branch.css">
  <style>
    ...
    <div class="courses">
      <div class="separator">
        <%
          ...
          LinkedList<MutipleInt> result= dao.rentBranch();
          for(MutipleInt rs :result){
            String branchNo=rs.getS1();
            Double rentSum = rs.getRentFee();
        %>
        <ul class="separator-class">
          <li><%=branchNo%></li>
          <li><%=rentSum%></li>
