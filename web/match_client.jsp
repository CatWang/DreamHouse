...
<div class="bar">
  <div class="bar-title bar-title-18"><h2>Client Data</h2></div>
    ...
    <div class="courses">
      <div class="separator">
        <%
          ...
          IClientDAO clientDAO = factory.getIClientDAOInstance();
          LinkedList<Client> result= clientDAO.clientMatch();
          for(Client client :result){
            String clientNo=client.getClientNo();
            String fName = client.getfName();
            String lName = client.getlName();
            String teleNo = client.getTeleNo();
            String email = client.getEmail();
            String type = client.getType();
            Double maxRent = client.getMaxRent();
            String staffNo = client.getStaffNo();
            Date joinDate = client.getJoinDate();
            String branchNo = client.getBranchNo();
        %>
        <ul class="separator-class">
          <li><%=clientNo%></li>
          <li><%=fName%>&nbsp;<%=lName%></li>
