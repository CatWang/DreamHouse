...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/three_clumn.css">
  <style>
...
<div class="bar">
  <div class="bar-title bar-title-18"><h2>Query Result</h2></div>
    ...
    <div class="courses">
      <div class="separator">
        <%
          ...
          IBranchDAO dao = factory.getIBranchDAOInstance();
          LinkedList<MutipleInt> result= dao.branchManager();
          for(MutipleInt rs :result){
            String fName=rs.getS1();
            String lName = rs.getS2();
            String branchNo = rs.getS3();
            String city = rs.getS4();
        %>
        <ul class="separator-class">
          <li><%=fName%>&nbsp;<%=lName%></li>
          <li><%=branchNo%></li>
