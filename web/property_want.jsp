...
<div class="bar">
  <div class="bar-title bar-title-18"><h2>Property Data</h2></div>
    ...
    <div class="courses">
      <div class="separator">
        <%
          ...
          IPropertyDAO propertyDAO = factory.getIPropertyDAOInstance();
          int room = Integer.parseInt(request.getParameter("room"));
          Double rent = Double.valueOf(request.getParameter("rent"));
          LinkedList<Property> result= propertyDAO.propertyWant(room, rent);
